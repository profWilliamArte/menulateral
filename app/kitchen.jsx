...
const API = 'https://dummyjson.com/products/category/kitchen-accessories';
...
const kitchen = () => {
    ...
    return (
        <View style={[styles.container, { backgroundColor: currentColors.background }]}>
            <Text style={{ color: currentColors.text, fontSize: 14, marginBottom: 20, textAlign: 'center' }}>({datos.length}) Accesorios para la Cocina </Text>
            <FlatList
                data={datos}
